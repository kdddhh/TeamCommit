...
<head>
<meta charset="UTF-8">
<link rel = "stylesheet" href = "/TeamCommit/resource/login/css/loginAll.css">
...
<div class="container" id="container">
  <div class="form-container sign-up-container">
    <form action="#">
	  ...
	  <a href="/TeamCommit/viewex/login/loginAgreeEmp.jsp">회원가입</a>
	  <button>로그인</button>
    </form>
  </div>
  ...
  <div class="overlay-container">
	...
	<script src = "/TeamCommit/resource/login/js/loginAll.js"></script>
</body>
</html>