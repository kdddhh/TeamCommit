...
<!-- 여기까지 복붙하기 -->    
<link rel="stylesheet" href="/TeamCommit/resource/board/css/boardReport.css" />
</head>
<body>
...
<br>
	<div class="report">
		...
		<div class="btn_boardreport">
				...
				<button class="btn_delete" onclick="location.href='/TeamCommit/viewex/board/board.jsp';">신고</button>
		</div>
	</div>
</body>
</html>
