...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="/TeamCommit/resource/Management/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="/TeamCommit/resource/Management/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                      </div>
  ...
  <!--   Core JS Files   -->
  <script src="/TeamCommit/resource/Management/js/core/popper.min.js"></script>
  <script src="/TeamCommit/resource/Management/js/core/bootstrap.min.js"></script>
  <script src="/TeamCommit/resource/Management/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="/TeamCommit/resource/Management/js/plugins/smooth-scrollbar.min.js"></script>
  <script>
