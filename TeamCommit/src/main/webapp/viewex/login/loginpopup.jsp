      ...
      <div class="contents">
        <form action="/" method="POST" id="form__wrap">
          <div class="terms__check__all">
            ...
            <label for="checkAll"
              >Kick Off 이용약관, 개인정보 수집 및 이용, 프로모션 정보 수신(선택)에<br />모두 동의합니다.</label
            >
          </div>
          <ul class="terms__list">
            <li class="terms__box">
              ...
              <div class="terms__content">
                여러분을 환영합니다. Kick Off 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 Kick Off
                서비스의 이용과 관련하여 Kick Off 서비스를 제공하는 JUN 주식회사(이하 ‘Kick Off’)와 이를 이용하는 Kick Off 서비스
                회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 Kick Off 서비스 이용에 도움이 될 수 있는
                유익한 정보를 포함하고 있습니다. Kick Off 서비스를 이용하시거나 Kick Off 서비스 회원으로 가입하실 경우 여러분은 본
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                개인정보보호법에 따라 Kick Off에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                Kick Off에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(Kick Off앱 알림 또는 문자), 이메일로 받아보실 수
                있습니다. 일부 서비스(별도 회원 체계로 운영하거나 Kick Off 가입 이후 추가 가입하여 이용하는 서비스 등)의
