...
<head>
<meta charset="UTF-8">
<link rel = "stylesheet" href = "/TeamCommit/resource/login/css/loginAgree.css">
...
<div class="container" id="container" style="overflow: auto; width: 500px; height: 500px; background: #F7F6DC​; border-radius: 10px;">
      ...
      <div class="contents">
        <form action="/" method="POST" id="form__wrap">
          ...
          <button type="button" class="next-button" onclick="location.href='/TeamCommit/viewex/login/SignupEmp.jsp';">확인</button>
        </form>
      </div>    
</div>
</body>
