...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="/TeamCommit/resource/Management/css/material-dashboard.css" rel="stylesheet" />
...
<%@include file="/resource/includes/header.jsp"%>
  ...
  <script src="/TeamCommit/resource/Management/js/material-dashboard.min.js"></script>
