...
- 1 != d && c === k && a.splice(d, 1)
                ...
                G = function (a) {
                    if (c === k || c === i) 
                        ...
                        h = a
                            ...
                            .trim(),
                        j && j._bAttrSrc
                            ? (N(j.mData._)(d, h), s(j.mData.sort, a), s(j.mData.type, a), s(
                                j.mData.filter,
                                a
                            ))
                            : q
        ...
        function Ja(a, b, c, d) {
            ...
            if (null === e.nTr) {
                ...
                for (m = a.aoColumns.length; n < m; n++) {
                    ...
                    i.fnCreatedCell && i
                        .fnCreatedCell
                        .call(a.oInstance, e, B(a, b, n), f, b, n)
                }
        ...
        function wb(a) {
            ...
            for (g = 0; g < c; g++) 
                ...
                s("mDataProp_" + g, i),
                d.bFilter && (s("sSearch_" + g, m.sSearch), s("bRegex_" + g, m.bRegex), s(
                    "bSearchable_" + g,
                    n.bSearchable
                )),
        ...
        function Ha(a) {
            ...
            if (d || !s && !f && !e && j == W(a) && j == n.length) 
                ...
                for (l = 0; l < i.length; l++) 
                    o = c[i[l]],
                    n[l].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig
                        ? w(o.sWidthOrig)
                        : "",
                    o.sWidthOrig && f && h(n[l]).append(
